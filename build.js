...
.blog-tag.active{background:#2667FF;color:#fff;border-color:#2667FF}
...
<section class="u-section">
  <div style="padding:clamp(160px,14vw,200px) 80px 80px;max-width:1600px;margin:0 auto;box-sizing:border-box">
